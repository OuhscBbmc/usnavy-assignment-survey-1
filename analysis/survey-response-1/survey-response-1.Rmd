...
-----------------------------------
```{r freq-assignment_priority-by-specialty_type, echo=echo_chunks, message=message_chunks}
```

Frequency: Officer_rank_priority by Officer_rank
-----------------------------------
```{r freq-officer_rank_priority-by-officer_rank, echo=echo_chunks, message=message_chunks}
```
